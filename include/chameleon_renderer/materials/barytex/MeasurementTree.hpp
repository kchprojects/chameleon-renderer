...
struct MeasurementTree {
    static const glm::vec2 base_A;
    static const glm::vec2 base_B;
    static const glm::vec2 base_C;
...
const glm::vec2 MeasurementTree::base_A = {0.f, 0.f};
const glm::vec2 MeasurementTree::base_B = {1.f, 0.f};
const glm::vec2 MeasurementTree::base_C = {0.5f, std::sqrt(0.75f)};
