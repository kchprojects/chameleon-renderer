...
void
Renderer::add_camera(const std::string& cam_label, const CalibratedCamera& cam)
{
    cameras[cam_label] = cam;
}
void
Renderer::setup_scene(const OptixStaticScene& new_scene)
{
    scene = new_scene;
    scene.setupAccel();
...
CalibratedCamera&
PhotometryRenderer::camera(const std::string& cam_label)
{
